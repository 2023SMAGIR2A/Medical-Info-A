...
Route::group(['middleware'=>['auth']],function (){
    ...
    Route::get('patients/{purchase}',[PatientController::class,'show'])->name('mes-patients');
    ...
    Route::get('doctors/{specialization}', [DoctorController::class, 'show'])->name('spezia');
    ...
    Route::get('consultations/{perso}', [ConsultationController::class, 'show'])->name('mezo');
    Route::post('consultations',[ConsultationController::class,'store']);
    Route::put('consultations',[ConsultationController::class,'update']);
    Route::delete('consultations',[ConsultationController::class,'destroy']);
