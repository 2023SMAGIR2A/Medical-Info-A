		...
		<div id="sidebar-menu" class="sidebar-menu">
			...
			<ul>
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						<li><a class="{{ Request::routeIs('patients') ? 'active' : '' }}"  href="{{route('patients')}}">All Patients</a></li>
						<li><a class="{{ Request::routeIs('spezia') ? 'active' : '' }}" href="{{route('spezia', ['specialization' => auth()->user()->id])}}">My Patients</a></li>

					</ul>
				</li>
				<!-- <li class="{{ Request::routeIs('patients') ? 'active' : '' }}"> 
					<a href="{{route('patients')}}"><i class="fe fe-users"></i> <span>Patients</span></a>
				</li>
				<li class="{{ Request::routeIs('spezia') ? 'active' : '' }}"> 
				<a href="{{route('spezia', ['specialization' => auth()->user()->id])}}"><i class="fe fe-users"></i> <span>My Patients List</span></a>
				</li> -->
				<li class="{{ Request::routeIs('mezo') ? 'active' : '' }}"> 
				<a href="{{route('mezo', ['perso' => auth()->user()->id])}}"><i class="fe fe-filter"></i> <span>My Consultation</span></a>
				</li>
				@endcan

				@can('view-patient')
				<li class="{{ Request::routeIs('doctors') ? 'active' : '' }}"> 
					<a href="{{route('doctors')}}"><i class="fe fe-users"></i> <span>Doctors</span></a>
				</li>
				@endcan
