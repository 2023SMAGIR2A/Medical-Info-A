						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<div class="actions">
										<a data-id="{{$consultation->id}}" data-name="{{$consultation->name}}" data-email="{{$consultation->email}}" class="btn btn-sm bg-success-light editbtn" id="edit-user" data-toggle="modal" href="javascript:void(0)">
											<i class="fe fe-pencil"></i> Edit
										</a>
										<a data-id="{{$consultation->id}}" href="javascript:void(0);" class="btn btn-sm bg-danger-light deletebtn" data-toggle="modal">
