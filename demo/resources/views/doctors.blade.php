...
<div class="col-sm-5 col">
	<a href="#add_user" data-toggle="modal" class="btn btn-primary float-right mt-2">Add Doctor</a>
</div>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="POST" enctype="multipart/form-data" action="{{route('doctors')}}">
					@csrf
					<div class="row form-row">
                        ...
                        <div class="col-12">
							<div class="form-group">
								...
								<div class="form-group">
									<select class="select2 form-select form-control" name="specialization">
