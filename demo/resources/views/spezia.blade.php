...
<!-- <div class="col-sm-5 col">
	<a href="#add_user" data-toggle="modal" class="btn btn-primary float-right mt-2">Add Patient</a>
</div> -->
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<div class="actions">
										<a data-id="{{$user->id}}" data-name="{{$user->name}}" data-email="{{$user->email}}" class="btn btn-sm bg-primary-light editbtn" id="edit-user" data-toggle="modal" href="javascript:void(0)">
											<i class="fe fe-plus"></i> consult
										</a>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="POST" enctype="multipart/form-data" action="{{route('patients')}}">
					@csrf
					<div class="row form-row">
                        ...
                        <div class="col-12">
							<div class="form-group">
								...
								<div class="form-group">
									<select class="select2 form-select form-control" name="diseases">
...
<div class="modal fade" id="edit_user" aria-hidden="true" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" enctype="multipart/form-data" action="{{route('consultations')}}">
					@csrf
					@method("POST")
					<div class="row form-row">
                        ...
                        <div class="col-12">
							<div class="form-group">
								<label>Libelle</label>
								<input type="text" name="wording" class="form-control edit_libelle" placeholder="Consultation">
							</div>
						</div>
						<div class="col-12">
							<div class="form-group">
								<label>Comments</label>
								<textarea name="comments" class="form-control edit_comment" placeholder="Comments">
                                </textarea> 
							</div>
						</div>
						...
						<div class="col-12">
							<div class="form-group">
								...
								<div class="form-group">
									<select class="select2 form-select form-control" name="drugs">
											<option value="Codeine">Codeine</option>
                                            <option value="Euphon">Euphon</option>
